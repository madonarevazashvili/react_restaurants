        ...
        <div className="header_container" >
            <nav>
                <NavLink to="/react_restaurants/">
                    <div className="header" style={{ width: "30%" }}>
                ...
                <NavLink to="/react_restaurants/cart">
                    <div className="header" style={{ width: "30%" }}>
                        ...
                        <p style={{color:"red", position: 'absolute',marginLeft:"40px",marginBottom:"60px",fontSize:"20px",fontWeight:"bold" }}>{context.number}</p>
